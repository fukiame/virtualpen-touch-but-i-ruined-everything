...
std::string manufacturer = "fukiame";
std::string model = "VTabletHost";
std::string description = "Virtual Tablet Host";
std::string version = "1.0";
std::string url = "https://github.com/fukiame/virtualpen-touch-but-i-ruined-everything";
